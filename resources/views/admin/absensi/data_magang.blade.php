        ...
        <div id="mainContent" class="flex flex-col transition-transform duration-300 w-full pl-0">
            ...
            <div id="popupLogout"
                ...
                <div class="bg-white rounded-md py-6 px-12 relative">
                    ...
                    <img id="closePopupLogout" src="/images/silang.png" alt="Close pop up"
                        class="absolute top-2 right-2 h-6 w-6 cursor-pointer">
                    <div class="flex space-x-4 mt-4">
                        <button id="btnBatalLogout"
                            class="bg-[#ECB131] text-white font-bold flex-1 py-2 rounded-md shadow">Batal</button>
                        <a href="/login"
                            class="bg-[#396E66] text-white font-bold flex-1 py-2 rounded-md shadow text-center inline-block">Ya</a>
                    </div>
                </div>
            </div>
            ...
            <script>
                ...
                // Event delegation untuk menangkap tombol hapus yang dibuat secara dinamis
                $(document).on('click', '.btnHapus', function() {
                    $('#popupHapus').removeClass('hidden');
                });

                // Menutup popup hapus
                $('#closePopupHapus, #btnBatal').on('click', function() {
