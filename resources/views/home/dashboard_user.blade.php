    ...
    <div class="relative h-screen overflow-hidden">
        <div id="mainContent" class="flex flex-col">
            <header class="bg-white border-b-2 border-[#396E66] p-4 flex items-center justify-between z-50 relative">
                ...
                <div id="modalProfile" class="absolute top-16 right-0 bg-white shadow-lg rounded-md w-64 hidden flex flex-col overflow-hidden">
                    ...
                    <a id="logoutButton" class="flex items-center px-4 py-2 w-full text-left hover:bg-gray-200 font-semibold text-black cursor-pointer">
        ...
        <main class="p-6">
            ...
            <div class="flex border-b border-gray-300">
                <button class="tab-btn px-6 py-2 font-semibold focus:outline-none text-gray-600 border-b-2 hover:text-[#396E66] hover:border-[#396E66]"
                    data-target="tab-presensi">
                    Table Presensi
                </button>
                <button class="tab-btn px-6 py-2 font-semibold focus:outline-none text-gray-600 border-b-2 hover:text-[#00307D] hover:border-[#00307D]"
